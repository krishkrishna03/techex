...
interface Test {
  ...
  endDateTime: string;
  createdAt: string;
  // Optional properties used by previews and test forms
  hasSections?: boolean;
  sections?: any[];
  questions?: any[];
  testType?: string;
...
const MasterAdminDashboard: React.FC<MasterAdminDashboardProps> = ({ activeTab, setActiveTab }) => {
  ...
  const handleViewTest = async (testId: string) => {
    try {
      ...
      setPreviewTest(testDetails as Test);
            ...
            <div className="space-y-4">
              ...
              <div className="max-h-96 overflow-y-auto space-y-4">
                ...
                {previewTest.hasSections && Array.isArray((previewTest as any).sections) ? (
                  ...
                  /* Fallback: non-sectioned test questions */
